	...
	<!--Main Body-->
     <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		<h1 class="page-header">Manage Patient Reports </h1>
		
		<h3 class="sub-header">Patient Report</h3>
		<div class="row">
            <div>
					<form class="form-inline" id="report" method="post" role="form" action="<?php echo base_url(); ?>patient/reports/print_report">
						<div class="form-group ">
						<select name="list" id="list" class="form-control" style="width: 250px";>
								<option value="0">--- Please Select Report ---</option>
								<option value="1">Patient Master List</option>
								<option value="2">List of Male Patient</option>
								<option value="3">List of Female Patient</option>									
							</select>	
						</div>  
						...
						<div class="form-group"> 				        		
							<a href="<?php echo base_url(); ?>patient/reports" class="btn btn-primary"><i class="fa fa-refresh"></i>Refresh</a>
						</div>						
					</form>
