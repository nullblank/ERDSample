...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="<?php echo base_url(); ?>assets/images/eGataPassLogo.png" type="image/png">
	<title>The CovidERP System | Patient Dashboard</title>	   
    <!-- Bootstrap core CSS -->
    <link href="<?php echo base_url();?>assets/css/admin/bootstrap.css" rel="stylesheet">
    <!-- Bootstrap Dashboard-->
	<link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/1/pos_style.css') ?>">
  ...
  <body>
    <nav class="navbar navbar-inverse navbar-fixed-top" style="background:url(<?php echo base_url();?>assets/images/header.jpg) fixed ; background-size:cover;">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">The CovidERP System | Patient Dashboard</a>
        </div>
